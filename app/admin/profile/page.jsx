...
import { Mail, Phone, User, Building2, Shield, Pencil, Key, } from "lucide-react";
...
export default function ProfilePage() {
  ...
  return (
    <div className="space-y-5 px-2 sm:px-4 md:px-6 py-4 m">
      ...
      <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-2xl overflow-hidden ">
        ...
        <div className="flex flex-col shadow-sm sm:flex-row items-center justify-end gap-3 px-4 sm:px-6 md:px-8 mb-4 sm:mb-6 md:mb-8">
